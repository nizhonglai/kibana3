...
|  --- | --- | --- |
|  [euiIconType?](./kibana-plugin-core-public.appnavoptions.euiicontype.md) | string | <i>(Optional)</i> A EUI iconType that will be used for the app's icon. This icon takes precendence over the <code>icon</code> property. |
