...
[Home](./index.md) &gt; [kibana-plugin-core-server](./kibana-plugin-core-server.md) &gt; [SavedObjectsMigrationVersion](./kibana-plugin-core-server.savedobjectsmigrationversion.md)
