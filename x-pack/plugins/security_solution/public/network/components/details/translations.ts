...
export const LOCATION = i18n.translate(
  'xpack.securitySolution.network.ipDetails.ipOverview.locationTitle',
  {
...
export const AUTONOMOUS_SYSTEM = i18n.translate(
  'xpack.securitySolution.network.ipDetails.ipOverview.autonomousSystemTitle',
  {
...
export const MAX_ANOMALY_SCORE_BY_JOB = i18n.translate(
  'xpack.securitySolution.network.ipDetails.ipOverview.maxAnomalyScoreByJobTitle',
  {
...
export const HOST_ID = i18n.translate(
  'xpack.securitySolution.network.ipDetails.ipOverview.hostIdTitle',
  {
...
export const HOST_NAME = i18n.translate(
  'xpack.securitySolution.network.ipDetails.ipOverview.hostNameTitle',
  {
    defaultMessage: 'Host name',
  }
);

export const WHOIS = i18n.translate(
  'xpack.securitySolution.network.ipDetails.ipOverview.whoIsTitle',
  {
...
export const VIEW_WHOIS = i18n.translate(
  'xpack.securitySolution.network.ipDetails.ipOverview.viewWhoisTitle',
  {
...
export const REPUTATION = i18n.translate(
  'xpack.securitySolution.network.ipDetails.ipOverview.ipReputationTitle',
  {
...
export const VIEW_VIRUS_TOTAL = i18n.translate(
  'xpack.securitySolution.network.ipDetails.ipOverview.viewVirusTotalTitle.',
  {
...
export const VIEW_TALOS_INTELLIGENCE = i18n.translate(
  'xpack.securitySolution.network.ipDetails.ipOverview.viewTalosIntelligenceTitle',
  {
...
export const AS_SOURCE = i18n.translate(
  'xpack.securitySolution.network.ipDetails.ipOverview.asSourceDropDownOptionLabel',
  {
    defaultMessage: 'As Source',
  }
);
export const AS_DESTINATION = i18n.translate(
  'xpack.securitySolution.network.ipDetails.ipOverview.asDestinationDropDownOptionLabel',
  {
...
export const INSPECT_TITLE = i18n.translate(
  'xpack.securitySolution.network.ipDetails.ipOverview.inspectTitle',
  {
