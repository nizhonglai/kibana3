...
export const useHostTactics = ({
  ...
  const [hostTacticsRequest, setHostTacticsRequest] = useState<HostTacticsRequestOptions | null>(
    null
  );
  ...
  const [hostTacticsResponse, setHostTacticsResponse] = useState<HostTacticsState>({
    data: [],
    endDate,
    id: ID,
    inspect: {
    ...
    (request: HostTacticsRequestOptions | null) => {
      ...
      const asyncSearch = async () => {
        ...
        searchSubscription.current = data.search
          .search<HostTacticsRequestOptions, HostTacticsStrategyResponse>(request, {
